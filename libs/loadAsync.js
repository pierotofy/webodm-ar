// Modified from expo-three to use custom MTLLoader

// @flow
import Expo from 'expo';

import resolveAsset, { stringFromAsset } from 'expo-three/lib/resolveAsset';
...
const loadOBJMTL = async (objLocalUri: string, mtlLocalUri: string, onProgress, assetProvider) => {
  ...
  mtlLoader.setPath(assetProvider);
  const materials = mtlLoader.parse(await loadRawFileAsync(mtlLocalUri));
  materials.preload();
